print("NL Mods - Export_Helios.lua invoked.\n")
--
--  This is used for controlling the Helios running on the remote machine.
--
...
-- Works once just before mission start.
    print("NL Mods - Export_Helios.Lua script exported and running LuaExportStart().\n")	
    ...
    print("NL Mods - Export_Helios.Lua script post require(socket).\n")	
    c = socket.udp()
	c:setsockname("*", 0)
    print("NL Mods - Export_Helios.lua will flush to "..gHost..":"..string.format("%i",gPort))
...
LuaExportActivityNextEvent = function (t)
    ...
    if PrevExport.LuaExportActivityNextEvent then
        olt = PrevExport.LuaExportActivityNextEvent(t)
        if lt > olt then 
            lt = olt -- use the lesser of the times to pass back
        end
    end
	return lt
end
...
print("NL Mods - Export_Helios.lua Completed.\n")
