...
--]]
print("NL Mods - Export.lua invoked.\n")
local default_output_file = nil

local lfs = require('lfs')  -- I presume this is to get the local file system
-- package.path  = package.path..";"..lfs.currentdir().."NL_mods\\?.lua"
...
-- These calls happen after the sample section because Helios takes the call points and Lights hooks into those call points.

print("NL Mods - Calling "..lfs.currentdir().."NL_mods\\Export_Helios.lua")
dofile(lfs.currentdir().."NL_mods\\Export_Helios.lua") --Helios version of Export.lua

print("NL Mods - Calling "..lfs.currentdir().."NL_mods\\ESP8266.lua")
dofile(lfs.currentdir().."NL_mods\\ESP8266.lua") -- My hooks for lights and signals

--print("NL Mods - Calling "..lfs.currentdir().."NL_mods\\LightsTest.lua")
--dofile(lfs.currentdir().."NL_mods\\LightsTest.lua") -- My hooks for lights Testing with the ESP WiFi UDP Listener

print ("NL Mods - Exports.lua completed.\n")
