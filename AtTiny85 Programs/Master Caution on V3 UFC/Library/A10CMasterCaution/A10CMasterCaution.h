/*
  A10CMasterCaution.h - I2C ATtiny85 used for Master Caution LED on the UFC of A-10C
  Revision 1.1
...
*/
#ifndef A10CMasterCaution_h
#define A10CMasterCaution_h
...
#define RETRYCOUNT    3
#define MASTERCAUTIONLED 0x02


class A10CMASTERCAUTION
{
private:
    uint8_t deviceaddress;
	
public:
    A10CMASTERCAUTION(uint8_t address);
    uint8_t readSwitch();
